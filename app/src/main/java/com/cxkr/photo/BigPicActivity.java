...
public class BigPicActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.example.photo.R.layout.activity_big_pic);
        tvSize = (TextView) findViewById(com.example.photo.R.id.tv_size);
        ivBigPic = (ImageView) findViewById(com.example.photo.R.id.iv_big_pic);
